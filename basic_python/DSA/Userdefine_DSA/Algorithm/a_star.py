...
def A_star_search(graph, heuristics, start_state,destination):
    ...
    while queue:
        ...
        if current == destination:
            print('Process Complete Destination found; Cost {}, Path {} '.format(cost, path))
            return cost, path
...
A_star_search(romania_graph, heuristics, 'Timisoara', 'Bucharest')
