...
# in the c-drive
browser = webdriver.Firefox()  # can be used with other browser as well
...
Signin_link = browser.find_element_by_link_text("Log In")
Signin_link.click()

# login/signing in processes , inspect the login for unique_id
username_box = browser.find_element_by_id("emailInput_4-input")
print(username_box)
username_box.send_keys("test@gmail.com")
password_box = browser.find_element_by_id("passwordInput_5-input")
