...
# Attach policy
aws iam attach-user-policy --user-name jack --policy-arn "arn:aws:iam::975049886938:policy/jack-s3"
...
aws sts assume-role --profile jack --role-arn "arn:aws:iam::339712740595:role/cross-account-s3-access" --role-session-name AWSCLI-Session --external-id 1234567
