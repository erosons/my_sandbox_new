            ...
            <nav class="dropList">
                  <ul>
                    <li><a title="Home" href="index.php" target="_self">Home</a></li>
                     ...
                     <li ><a title="Account" href="testcarting.php" target="_self">Account</a>
                    ...
                    <a title="Cart" href="cart.php" target="_self">Cart<img alt="Cart" src="images/shopping-cart.png" width="25" height="17" ></a></li> 
                  </ul> 
           </nav>
           <nav class="Search">
