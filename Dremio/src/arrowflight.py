...
def parse_arguments():
    ...
    parser.add_argument('-user', '--username', type=str, help='Dremio username. Defaults to \"dremio\".',
                        default="dremio")
    parser.add_argument('-pass', '--password', type=str, help='Dremio password. Defaults to \\".',
                        default=")
...
def connect_to_dremio_flight_server_endpoint(host, port, username, password, query,
    ...
    try:
        ...
        if query:
            ...
            #print('[INFO] Query: ', query)# Commented by Ali
            ...
            #print('[INFO] Schema: ', schema)# Commented by Ali
            ...
            #print('[INFO] Ticket: ', flight_info.endpoints[0].ticket) # Commented by Ali

            # Retrieve the result set as a stream of Arrow record batches.
            reader = client.do_get(flight_info.endpoints[0].ticket, options)
            #print('[INFO] Reading query results from Dremio') # Commented by Ali
            df = reader.read_pandas(timestamp_as_object=True,use_threads=True)
            #print(df.head()) # Commented by Ali
            return df
